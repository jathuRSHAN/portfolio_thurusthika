  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.linkedin.com/in/thurusthika-nesalingam-8a2524143/"
            ...
            <li>
              <a
                href="https://www.instagram.com/thurusthi_15/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.youtube.com/channel/UCtjV9Q-93YPiPhCAa0Tla5w"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
                ...
                >
                  <path
                    d="M23.498 6.186a2.974 2.974 0 0 0-2.093-2.103C19.696 3.5 12 3.5 12 3.5s-7.696 0-9.405.583A2.974 2.974 0 0 0 .502 6.186 31.075 31.075 0 0 0 0 12c.001 2.025.167 4.028.502 5.814a2.974 2.974 0 0 0 2.093 2.103C4.304 20.5 12 20.5 12 20.5s7.696 0 9.405-.583a2.974 2.974 0 0 0 2.093-2.103C24 16.028 24 12 24 12s0-4.028-.502-5.814ZM9.75 15.568V8.432l6.25 3.568-6.25 3.568Z"
                    fill="black"
                  />
                </svg>
              </a>
            ...
            <li>
              <a
                href="https://www.facebook.com/profile.php?id=100007118597808"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made by Jathu</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
